...
let obj2 = new Product("../image/3.jpg", "Hoa Hồng Đỏ", 200);
let obj3 = new Product("../image/3.jpg", "Hoa Hồng Đỏ", 200);
let obj4 = new Product("../image/3.jpg", "Hoa Hồng Đỏ", 200);
let obj5 = new Product("../image/3.jpg", "Hoa Hồng Đỏ", 200);
let obj6 = new Product("../image/3.jpg", "Hoa Hồng Đỏ", 200);
